...
const navigation = [
  ...
  {
    name: 'My Timesheet',
    href: '/home/mytimesheet',
    icon: CalendarIcon,
    current: false
  },
  {
    name: 'My Working Time',
    href: '/home/myworkingtime',
    icon: DocumentDuplicateIcon,
    current: false
  },
  { name: 'Reports', href: '/home/reports', icon: ChartPieIcon, current: false }
]
const teams = [
  ...
  return (
    <>
      <div>
        ...
        <div className="hidden lg:fixed lg:inset-y-20 lg:z-50 lg:flex lg:w-72 lg:flex-col -mt-4">
          {/* Sidebar component, swap this element with another sidebar if you like */}
