...
import { WorkingTime } from '../../Project Management/components/WorkingTime'
  ...
  return (
    <>
      <div className="mx-auto max-w-7xl lg:flex lg:gap-x-16 lg:px-8">
        {currentUser != null ? (
          <>
            <aside className="flex overflow-x-auto border-b border-gray-900/5 py-4 lg:block lg:w-56 lg:flex-none lg:border-0 lg:py-20">
            ...
            <main className="px-4 py-16 sm:px-6 lg:flex-auto lg:px-12 lg:py-20">
