export const About = (): JSX.Element => {
  ...
  const values = [
    ...
    {
      name: 'Automated end to end testing',
      description:
  ...
  return (
    <div>
      <main className="isolate">
              ...
              <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                <div className="w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                  <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
                    We simplified Timesheets Management
                  </h1>
                  <p className="relative mt-6 text-lg leading-8 text-gray-600 sm:max-w-md lg:max-w-none">
                    TimeWise is the ultimate time-management companion that
                    simplifies timesheets and elevates calendar management to a
                    whole new level of efficiency. Take charge of your time,
                    track projects, and optimize your daily routine with ease.
                    TimeWise&apos;s elegant design and powerful features will
                    transform the way you work, making you more productive and
                    leaving you with more time for what matters most.
                  </p>
                </div>
            ...
            <div className="mt-6 flex flex-col gap-x-8 gap-y-20 lg:flex-row">
              <div className="lg:w-full lg:max-w-2xl lg:flex-auto">
                <p className="text-xl leading-8 text-gray-600">
                  Calendify empowers you to become the master of your time. With
                  its personalized time-tracking capabilities and calendar
                  wizardry, you&apos;ll effortlessly manage your busy schedule
                  like never before.
                </p>
                <div className="mt-10 max-w-xl text-base leading-7 text-gray-700">
                  <p>
                    Seamlessly integrate your tasks, set reminders, and achieve
                    a perfect work-life balance with Calendify. Simplify your
                    days, boost productivity, and unlock the true potential of
                    your time.&quot;
                  </p>
                  <p className="mt-10">
        ...
        {/* Turn back button */}
        <div className="mt-10 flex justify-end items-center gap-x-6 px-10 py-10">
          <a
            href="/"
            className="text-sm font-semibold leading-6 text-textSecondary"
          >
